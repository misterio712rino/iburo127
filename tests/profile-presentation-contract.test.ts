...
assert.match(editorSource, /absolute -bottom-1 -right-1 grid size-11/);
assert.match(editorSource, /absolute right-3 top-3 grid size-11/);
assert.match(editorSource, /rounded-2xl border border-border bg-muted\/60 p-4 pr-16/);
assert.doesNotMatch(editorSource, /\bsize-(?:8|9)\b/);
