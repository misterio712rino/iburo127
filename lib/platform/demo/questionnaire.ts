...
export function getQuestionnaireProgress(identityId:string) { const seed=getQuestionnaireSeed(identityId);return seed?Math.round(new Set(seed.initialCompletedSectionIds).size/QUESTIONNAIRE_SECTIONS.length*100):undefined; }
