...
export const DEMO_IDENTITIES: readonly DemoIdentity[] = [
  ...
  { id: "mikhail-manager", displayName: "Михаил Воронцов", initials: "МВ", role: "MANAGER" },
] as const;

export const DEFAULT_CLIENT_IDENTITY = DEMO_IDENTITIES[0]!;
export const LAWYER_IDENTITY = DEMO_IDENTITIES.find((identity) => identity.id === "anna-lawyer")!;
export const MANAGER_IDENTITY = DEMO_IDENTITIES.find((identity) => identity.id === "mikhail-manager")!;
