...
const BRIDGE_SCANNER_DIAGNOSTIC_PATTERN =
  /^SCANNER_(?:INVALID_CONFIG|INVALID_SOURCE_URL|INVALID_INPUT|HTTP_5XX|HTTP_4XX|INVALID_RESPONSE|TIMEOUT|NETWORK_(?:DNS|CONNECT_TIMEOUT|REFUSED|RESET|ROUTE|TLS|ERROR))$/;
