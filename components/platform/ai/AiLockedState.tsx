    ...
    <div className="flex flex-col gap-8">
      ...
      <PlatformCard className="relative overflow-hidden p-6 sm:p-10">
        ...
        <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-[-.045em]">
          AI-помощник не включён в текущий тариф дела
        </h2>
        <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground">
          Доступ определяется сервером по возможностям тарифа конкретного дела. Ваши остальные инструменты продолжают работать без изменений.
        </p>
        <Button
          render={<Link href="/app/client" />}
          nativeButton={false}
          variant="outline"
