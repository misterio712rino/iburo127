...
const FILTERS: readonly { code: Filter; label: string }[] = [{ code: "ALL", label: "Все" }, { code: "ATTENTION", label: "Требуют внимания" }, { code: "LITE", label: "ЛАЙТ" }, { code: "PRO", label: "ПРО" }, { code: "INDIVIDUAL", label: "ИНДИВИДУАЛЬНЫЙ" }];
