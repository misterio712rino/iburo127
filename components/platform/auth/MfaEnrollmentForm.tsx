...
export function MfaEnrollmentForm({ completionHref = "/portal" }: Props) {
    ...
    return (
      <form onSubmit={begin} className="space-y-4" aria-busy={pending}>
        <div className="rounded-[20px] border border-slate-100 bg-slate-50/60 p-4 sm:p-5">
          <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Подготовка</p>
          ...
          <input
            ...
            className="min-h-11 w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-base outline-none transition focus:border-slate-400 focus:ring-4 focus:ring-slate-100"
          />
          </div>
        </div>
        ...
        <button
          ...
          className="inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-primary bg-primary px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#9f1923] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
        >
  ...
  return (
    <div className="space-y-4">
      <section className="min-w-0 rounded-[20px] border border-slate-200 bg-slate-50/60 p-4 sm:p-5">
        <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Шаг 1 из 3</p>
        <h2 className="mt-1 break-words text-base font-semibold text-slate-900">Добавьте iБюро в аутентификатор</h2>
        ...
        <a
          ...
          className="mt-4 inline-flex min-h-11 w-full max-w-full items-center justify-center break-words rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/10 sm:w-auto"
        >
          Открыть в приложении-аутентификаторе
        </a>
        {secret ? (
          <div className="mt-4 min-w-0 rounded-xl border border-slate-200 bg-white p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-400">Секрет для ручного ввода</p>
            <code className="mt-2 block break-all text-sm font-semibold text-slate-800">{secret}</code>
            <button type="button" onClick={copySecret} className="mt-3 inline-flex min-h-11 items-center gap-2 rounded-xl px-2 text-xs font-semibold text-[#7B2330] hover:bg-[#f8e9ea] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#7B2330]/15">
      ...
      <section className="min-w-0 rounded-[20px] border border-amber-200/80 bg-amber-50/80 p-4 sm:p-5">
        ...
        <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-amber-900/60">Шаг 2 из 3</p>
        <h2 className="mt-1 break-words text-base font-semibold text-amber-950">Сохраните резервные коды</h2>
      ...
      <form onSubmit={verify} className="rounded-[20px] border border-slate-100 bg-white p-4 shadow-none sm:p-5" aria-busy={pending}>
        <div className="flex min-w-0 items-start gap-3">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Шаг 3 из 3</p>
          ...
          <input
            ...
            className="min-h-14 w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-center text-2xl font-semibold tracking-[0.35em] outline-none transition focus:border-slate-400 focus:ring-4 focus:ring-slate-100"
          />
          </div>
        </div>
        ...
        <button
          ...
          className="mt-4 inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-primary bg-primary px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#9f1923] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
        >
